...
//! endpoint; see docs/architecture/security_lock.md.
typedef enum {
...
//! A database id of 31 would land on the bit above and report a raw-flash erase
//! that never happened.
_Static_assert(NumBlobDBs <= 31, "BlobDBId collides with SECURITY_SHRED_NON_BLOBDB_BIT");
...
//!
//! Destroys nothing at all when nothing has been written since the last wipe.
//!
...
//! docs/architecture/security_lock.md for the reasoning.
//!
...
//! @return bitmap of what was wiped, for SHRED_COMPLETE. 0 when nothing was
//!         destroyed, whether because nothing ran or because there was nothing
//!         left to destroy.
