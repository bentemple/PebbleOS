...
//! The event's reason code is deliberately not forwarded: one of the values
//! says the user entered the duress PIN, and a wipe has to look the same to an
//! app whatever caused it.
